...
def test_chunk_lists_and_circular_shift():
    ...
    assert np.array_equal(out["n7"][0], ["whisky", "water", "vase", "umbrella", "turtle", "tree", "tractor"])
    assert np.array_equal(out["n7"][1], ["tractor", "whisky", "water", "vase", "umbrella", "turtle", "tree"])
    assert np.array_equal(out["n7"][2], ["tree", "tractor", "whisky", "water", "vase", "umbrella", "turtle"])
    assert np.array_equal(out["n7"][3], ["turtle", "tree", "tractor", "whisky", "water", "vase", "umbrella"])
    assert np.array_equal(out["n7"][4], ["umbrella", "turtle", "tree", "tractor", "whisky", "water", "vase"])
    assert np.array_equal(out["n7"][5], ["vase", "umbrella", "turtle", "tree", "tractor", "whisky", "water"])
    assert np.array_equal(out["n7"][6], ["water", "vase", "umbrella", "turtle", "tree", "tractor", "whisky"])
