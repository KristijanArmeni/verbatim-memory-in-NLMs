...
scripts_dir = os.path.join(root_dir, "src", "greene_scripts", "wm_eval", "awd_lstm")
log_dir = "/scratch/ka2773/project/lm-mem/logs/wm_eval/awd_lstm"
checkpoint_root = "/scratch/ka2773/project/lm-mem/checkpoints/"

master_bash = open(os.path.join(scripts_dir, 'run_awd_greene_jobs.sh'), 'w')
...
for tag in modeldict.keys():
    for scenario in ["sce1rnd", "sce2", "sce4", "sce5", "sce6"]:
        for condition in ["repeat", "permute", "control"]:
            for list_type in ["random", "categorized"]:
                ...
                python_script = os.path.join(root_dir, "src", "src", "wm_suite", "experiment.py")
                ...
                f.write("cd /home/ka2773/project/lm-mem/src/src/wm_suite/awd_lstm\n\n")
