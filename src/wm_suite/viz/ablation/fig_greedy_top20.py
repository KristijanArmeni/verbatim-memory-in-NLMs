...
fig = plot_search_x1x2(xarr=x[0], y1tup=x1, y2tup=x2, y3tup=ctrl_tup_x1, y4tup=ctrl_tup_x2)
plt.show()
...
fig = plot_search_x1x2(xarr=x_n1[0], y1tup=x1_n1, y2tup=x2_n1, y3tup=ctrl_tup_x1, y4tup=ctrl_tup_x2)
plt.show()
