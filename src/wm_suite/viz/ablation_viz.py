...
dat1 = pd.read_csv(
    "/scratch/ka2773/project/lm-mem/output/ablation/ablate-10-7_merge.csv", sep="\t"
)
dat0 = pd.read_csv(
    "/scratch/ka2773/project/lm-mem/output/ablation/pretrained_merge.csv", sep="\t"
)
...
dat1_, _ = filter_and_aggregate(
    dat1,
    model="gpt2",
    model_id="ablate-10-7",
    groups=variables,
