...
if argins.which == "ngrams-random":
    ...
    n_reps = 5
    word_lists = {"2-gram": [np.tile(l[0:2], reps=n_reps) for l in word_lists_tmp["list-3"][0]],
                  "3-gram": [np.tile(l[0:3], reps=n_reps) for l in word_lists_tmp["list-5"][0]],
                  "5-gram": [np.tile(l[0:5], reps=n_reps) for l in word_lists_tmp["list-10"][0]],
                  "7-gram": [np.tile(l[0:7], reps=n_reps) for l in word_lists_tmp["list-10"][0]],
                  "10-gram": [np.tile(l[0:10], reps=n_reps) for l in word_lists_tmp["list-10"][0]]
                  }
